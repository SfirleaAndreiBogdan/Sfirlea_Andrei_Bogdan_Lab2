...
namespace Sfirlea_Andrei_Bogdan_Lab2.Data
{
    public class Sfirlea_Andrei_Bogdan_Lab2Context : DbContext
    {
        ...
        public DbSet<Sfirlea_Andrei_Bogdan_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Sfirlea_Andrei_Bogdan_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Sfirlea_Andrei_Bogdan_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
